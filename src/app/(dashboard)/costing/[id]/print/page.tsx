      ...
      <div className="print-surface relative max-w-3xl mx-auto p-8 bg-white">
        ...
        <div className="border-t-2 border-gray-200 pt-6 grid grid-cols-2 gap-8 text-xs text-gray-500">
          ...
          <div className="text-right">
            ...
            <p>Director, GS Energy Systems (Pvt) Ltd.</p>
          </div>
        </div>

        <p className="text-center text-xs text-gray-400 mt-6">Generated by GS Energy Solar ERP · {new Date().toLocaleString("en-PK")}</p>
      </div>
    </>
  )
}
