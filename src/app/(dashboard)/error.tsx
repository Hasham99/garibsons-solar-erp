  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="w-full max-w-md text-center animate-fade-in-up">
        <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-full bg-rose-50 text-rose-500 ring-1 ring-inset ring-rose-100">
        ...
        {error.digest && (
          <p className="mt-2 text-xs text-slate-400 tabular-nums">Error reference: {error.digest}</p>
        )}
